...
def get_db_path():
    ...
    # التحقق مما إذا كان التطبيق يعمل على أندرويد
    if "ANDROID_ARGUMENT" in os.environ:
        # استخدام المسار الخاص بالتطبيق (Internal Storage) المسموح بالكتابة فيه
        return os.path.join(os.environ["ANDROID_PRIVATE"], "hisn_almuslim.db")
    
    # الوضع العادي (الكمبيوتر)
